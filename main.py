...
from core.eda import eda_router
from core.eda.advanced_eda import advanced_eda_router
...
def _include_routers(app: FastAPI) -> None:
    ...
    # EDA routes (from core/eda)
    try:
        app.include_router(eda_router)
    except Exception:
        logger.debug("eda_router not available to include")

    # Advanced EDA routes (from core/eda/advanced_eda)
    try:
        app.include_router(advanced_eda_router)
    except Exception:
        logger.debug("advanced_eda_router not available to include")
