...
// === MODULE: DATA SOURCES MANAGEMENT (target: data_sources.js) [BEGIN] ===
    ...
    function displayDataSourcesList(sources) {
                        ...
                        <div class="data-source-header">
                            ...
                            <div class="source-actions-column">
                                ...
                                <div class="eda-action-row mt-2">
                                    <button class="btn btn-gradient-eda-prominent" onclick="moveToEDAFromList('${source.source_id}', '${safeSourceName}')" title="Move to EDA - Exploratory Data Analysis">
                                        <i class="fas fa-chart-line"></i> Move to EDA
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        function previewDataSource(sourceId) {
            ...
            Promise.all([
                fetch(`/eda/api/sources/${sourceId}/preview?sample_size=100`, getAuthFetchOptions()).then(r => r.json()),
                fetch(`/eda/api/sources/${sourceId}/quality-report?sample_size=500`, getAuthFetchOptions()).then(r => r.json())
            ])
