                    ...
                    const completionMessage = `
                        <div class="ingestion-complete">
                            ...
                            <div class="completion-actions">
                                ...
                                <button class="btn-modern btn-secondary-modern" onclick="window.location.href='/advanced-eda/?source_id=${fileInfo.source_id}'">
                                    <i class="fas fa-chart-line"></i> Open in EDA
                                </button>
                            </div>
                        </div>
                    `;
